                                                ...
                                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $ret = "SELECT * FROM  products p INNER JOIN product_categories pc
                                                            ON pc.category_id = p.product_category_id WHERE p.product_access_level = '$store'  ";
                                                        $stmt = $mysqli->prepare($ret);
                                                        $stmt->execute(); //ok
                                                        $res = $stmt->get_result();
                                                                            ...
                                                                            <div class="drodown">
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                                    <ul class="link-list-opt no-bdr">
                                                                                        <li><a data-toggle="modal" href="#update-<?php echo $products->product_id; ?>"><em class="icon ni ni-edit"></em><span>Add New Stock</span></a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                                    ...
                                                                                    <div class="card-body">
                                                                                        <div class="row">
                                                                                            <div class="form-group col-md-12">
                                                                                                <label for="">Enter New  stock </label>
