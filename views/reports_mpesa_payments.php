        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"> Rooms Reservations MPESA Payment Records </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table id="export-data-table" class="table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $ret = "SELECT * FROM stkpush s
                                        INNER JOIN reservations r ON s.mpesaReceiptNumber = r.transaction_id
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    Amount : Ksh <?php echo $reservations->amount; ?><br>
                                                    TXN ID : <?php echo $reservations->mpesaReceiptNumber; ?> <br>
                                                    Date : <?php echo date('d M Y g:ia', strtotime($reservations->transactionDate)); ?><br>
                                                </td>
                                                <td>
