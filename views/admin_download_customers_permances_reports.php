...
$html = '
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i> <b> Customer Purchase Record  From ' . $from . ' To ' . $to . ' | Generated On ' . date('d M Y') . '</b></i>
            </div>
            ...
            <h3 class="list_header" align="center">
                ...
                <hr class="red">
                <h4>Customer Purchase Reports From ' . $from . ' To ' . $to . ' </h4>
            </h3>
        ...
        '
                <tr>
                    <td width="2%">' . $cnt . '</td>
                    <td width="80%">
                    ' . $sales->sale_receipt_number . '
                    </td>
                    <td width="100%">
                    R.C.C : ' . $sales->sale_customer_name . '<br>
                    D.C.C : ' . $sales->sale_customer_phoneno . '<br>
                    </td>
                    <td width="100%">
                    ' . $sales->product_name . ' - '.$sales->category_name.'
                    </td>
                    <td width="50%">
                    ' . $sales->sale_quantity . ' Copies
                    </td>
                    <td width="50%">
                    Ksh ' . $sales->product_retail_price . ' 
                    </td>
                    <td width="100%">
                ...
                $html .= '
                <tr>
                    <td colspan="7" width="35%">Total Revenue  From ' . $from . ' To ' . $to . ':</td>
                    <td width="35%"> Ksh ' . $total_revenue . ' </td>
                </tr>
...
$dompdf->set_paper('A4', 'partial');
$dompdf->set_option('isHtml5ParserEnabled', true);
$dompdf->render();
$dompdf->stream($from . ' To ' . $to . ' Customer purchase Records', array("Attachment" => 1));
