...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    if ($stmt) {
        $success = "Deleted" && header("refresh:1; url=staff_products");
    } else {
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body text-center text-danger">
                                                                                ...
                                                                                <a href="staff_products?delete=<?php echo $products->product_id; ?>" class="text-center btn btn-danger"> Delete </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
