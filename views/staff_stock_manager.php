...
if (isset($_POST['update_stock'])) {
    ...
    $rc = $stmt->bind_param('ss',  $new_stock, $product_id);
    $stmt->execute();
    if ($stmt) {
                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h2 class="nk-block-title fw-normal">Manage Products Stock</h2>
                                            </div>
                                                ...
                                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                    <thead>
                                                        <tr class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <th class="nk-tb-col"><span class="sub-text">Quantity On Stores</span></th>
                                                                            ...
                                                                            <div class="drodown">
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                                    <ul class="link-list-opt no-bdr">
                                                                                        <li><a data-toggle="modal" href="#update-<?php echo $products->product_id; ?>"><em class="icon ni ni-edit"></em><span>Update Stock</span></a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                    ...
                                                                    <div class="modal-dialog  modal-lg">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h4 class="modal-title">Update <?php echo $products->product_name; ?> Stock</h4>
