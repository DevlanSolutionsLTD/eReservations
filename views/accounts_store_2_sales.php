                    ...
                    <div class="nk-content-inner">
                        <div class="nk-content-body">
                                    ...
                                    <div class="nk-block-head-content">
                                        <nav>
                                            <ul class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li class="breadcrumb-item active">Store 2 Sales</li>
                                            </ul>
                                        </nav>
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h2 class="nk-block-title fw-normal">Store 2 Sales Reports</h2>
                                            </div>
                            ...
                            <div class="nk-block">
                                ...
                                ?>
                                    <div class="text-center">
                                        <a href="accounts_download_store2_reports?start=<?php echo $start_date; ?>&end=<?php echo $end_date; ?>" class="btn btn-white btn-outline-light">
                                                ...
                                                <div class="card-inner">
                                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            WHERE p.product_access_level  = 'store_2' AND  (sale_date BETWEEN '$start_date' AND '$end_date') ";
