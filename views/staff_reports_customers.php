                        ...
                        <div class="nk-content-body">
                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h2 class="nk-block-title fw-normal">Customers Purchases</h2>
                                            </div>
                            ...
                            <div class="nk-block">
                                <fieldset class="border border-primary p-2">
                                    <legend class="w-auto text-center text-primary font-weight-bold"> Select Any Date Range To Generate Purchases </legend>
                                ...
                                ?>
                                    <div class="text-center">
                                        <a href="staff_download_customers_permances_reports?start=<?php echo $start_date; ?>&end=<?php echo $end_date; ?>" class="btn btn-white btn-outline-light">
                                            <em class="icon ni ni-download"></em>
                                            <span>
                                                Download Customer Purchases
                                            </span>
                                        </a>
                                    </div>
                                    <br>
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr class="nk-tb-item">
                                                                    <td class="nk-tb-col tb-col-mb">
                                                                        <span class="tb-amount"><?php echo $sales->sale_receipt_number; ?></span>
                                                                    </td>
                                                                    <td class="nk-tb-col tb-col-mb">
