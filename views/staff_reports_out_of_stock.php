                    ...
                    <div class="nk-content-inner">
                        <div class="nk-content-body">
                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h2 class="nk-block-title fw-normal">Current Out Of Stock Products Report</h2>
                                            </div>
                            ...
                            <div class="text-right">
                                <a href="staff_reports_download_out_of_stock" class="btn btn-white btn-outline-light"><em class="icon ni ni-download"></em><span>Download Report</span></a>
                            </div>
                            <hr>
                                                ...
                                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                    <thead>
                                                        <tr class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <th class="nk-tb-col"><span class="sub-text">Access Level</span></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
