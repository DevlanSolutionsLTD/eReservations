                        ...
                        <div class="nk-content-body">
                                    ...
                                    <div class="nk-block-head-content">
                                        <nav>
                                            <ul class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li class="breadcrumb-item active">Staff Perfomances </li>
                                            </ul>
                                        </nav>
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h2 class="nk-block-title fw-normal">Staff Perfomances Sales</h2>
                                            </div>
                            ...
                            <div class="nk-block">
                                <fieldset class="border border-primary p-2">
                                    <legend class="w-auto text-center text-primary font-weight-bold"> Select Staff Name To Generate Sales Records </legend>
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <label for="">Select Staff Details</label>
                                                    <select name="user_id" class="form-select form-control form-control-lg" data-search="on">
                                                        <?php
                                                        $ret = "SELECT * FROM  users WHERE user_access_level !='admin' ";
                                ...
                                ?>
                                    <div class="text-center">
                                        <a href="staff_download_staff_sales?user_id=<?php echo $user_id; ?>" class="btn btn-white btn-outline-light">
                                            <em class="icon ni ni-download"></em>
                                            <span>
                                                Download Staffs Sales Record
                                            </span>
                                        </a>
                                    </div>
                                    <br>
