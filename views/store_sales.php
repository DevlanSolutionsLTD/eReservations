                    ...
                    <div class="nk-content-inner">
                        <div class="nk-content-body">
                                    ...
                                    <div class="nk-block-head-content">
                                        <nav>
                                            <ul class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li class="breadcrumb-item active">Slaes</li>
                                            </ul>
                                        </nav>
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h2 class="nk-block-title fw-normal">Manage Store Sales</h2>
                                            </div>
                            ...
                            <div class="text-right">
                                <a href="staff_download_sale_entry_file" class="btn btn-white btn-outline-light"><em class="icon ni ni-file"></em><span>Sales Entry File</span></a>
                                <a href="#add_modal" data-toggle="modal" class="btn btn-white btn-outline-light"><em class="icon ni ni-plus"></em><span>Register New Purchase</span></a>
                            </div>
                            <hr>
                            <!-- Add Modal -->
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select name="sale_product_id" class="form-select form-control form-control-lg" data-search="on">
                                                                ...
                                                                WHERE p.product_access_level = '$store'";
                                                                $stmt = $mysqli->prepare($ret);
                                                                $stmt->execute(); //ok
                                                                $res = $stmt->get_result();
                                                                while ($product = $res->fetch_object()) {
