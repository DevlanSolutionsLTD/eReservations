    ...
    <html>
        ...
        <body style="margin:1px;">
            ...
            <h3 class="list_header" align="center">
                ...
                <hr class="red">
                <h4>Sales Reports From ' . $from . ' To ' . $to . ' </h4>
            </h3>
            ...
            WHERE p.product_access_level = '$store' AND ( s.sale_date BETWEEN '$start_date' AND '$end_date') ";
            ...
            while ($sales = $res->fetch_object()) {
                ...
                $html .= '
                <tr>
                    <td colspan="7"><b>Total Sales Revenue From '.$from.' To '.$to.'</b></td>
