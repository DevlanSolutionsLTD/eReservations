...
if (isset($_POST['add_product'])) {
    ...
    $product_access_level = $_POST['product_access_level'];
...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    if ($stmt) {
        $success = "Deleted" && header("refresh:1; url=admin_products");
    } else {
                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li><a href="#add_modal" data-toggle="modal" class="btn btn-white btn-outline-light"><em class="icon ni ni-plus"></em><span>Register New Product</span></a></li>
                                                        <li><a href="admin_bulk_import_products" class="btn btn-white btn-outline-light"><em class="icon ni ni-upload"></em><span>Bulk Import Products</span></a></li>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        <label for="">Product Access Level</label>
                                                                        <select required name="product_access_level" class="form-select form-control form-control-lg" data-search="on">
                                                                            <option value="all">Available At Both Stores</option>
                                                                            <option value="store_1">Available At Store 1</option>
                                                                            <option value="store_2">Available At Store 2</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                        <thead>
                                                            <tr class="nk-tb-item nk-tb-head">
                                                                ...
                                                                <th class="nk-tb-col"><span class="sub-text">Stores Availability</span></th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr class="nk-tb-item">
                                                                    ...
                                                                    <td class="nk-tb-col tb-col-mb">
                                                                        <span class="tb-amount"><?php echo $products->product_access_level; ?></span>
                                                                    </td>
                                                                                ...
                                                                                <div class="drodown">
                                                                                    ...
                                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                                        <ul class="link-list-opt no-bdr">
                                                                                            ...
                                                                                            <li><a data-toggle="modal" href="#delete-<?php echo $products->product_id; ?>"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                                        </ul>
                                                                                    </div>
                                                                                </div>
                                                                            </li>
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body text-center text-danger">
                                                                                    ...
                                                                                    <br>
                                                                                    <p>Heads Up, You are about to delete this product. This action is irrevisble.</p>
                                                                                    <button type="button" class="text-center btn btn-success" data-dismiss="modal">No</button>
                                                                                    <a href="admin_products?delete=<?php echo $products->product_id; ?>" class="text-center btn btn-danger"> Delete </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
