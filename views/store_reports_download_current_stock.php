 ...
 * install and activate this system on two separated uters solely for your personal and non-commercial use,
...
$html = '
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i> <b> Current Stock.  Generated On ' . date('d M Y') . '</b></i>
            </div>
            ...
            $html .=
                ...
                <tr>
                    ...
                    <td width="35%">' . $products->category_name . ' </td>
                    <td width="40%">' . $products->product_quantity  . ' </td>
                    <td width="40%">Ksh ' . $products->product_wholesale_price . ' </td>
                    <td width="40%">Ksh ' . $products->product_retail_price . '</td>
                </tr>
                            ';
                $cnt = $cnt + 1;
            }
...
$dompdf->render();
$dompdf->stream('Current Stock Records', array("Attachment" => 1));
