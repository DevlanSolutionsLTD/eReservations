                    ...
                    <div class="nk-content-inner">
                        <div class="nk-content-body">
                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h2 class="nk-block-title fw-normal">Sales Reports</h2>
                                            </div>
                            ...
                            <div class="nk-block">
                                ...
                                ?>
                                    <div class="text-center">
                                        <a href="store_download_sales_reports?start=<?php echo $start_date; ?>&end=<?php echo $end_date; ?>" class="btn btn-white btn-outline-light">
                                                    ...
                                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                        <thead>
                                                            <tr class="nk-tb-item nk-tb-head">
                                                                <th class="nk-tb-col"><span class="sub-text">Receipt Number</span></th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            WHERE p.product_access_level  = '$store' AND  (sale_date BETWEEN '$start_date' AND '$end_date') ";
