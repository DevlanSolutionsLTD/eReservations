                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Staffs Sales Perfomances</h3>
                                ...
                                <div class="nk-block">
                                    ...
                                    ?>
                                        <div class="text-center">
                                            <a href="admin_download_staff_sales?user_id=<?php echo $user_id; ?>" class="btn btn-white btn-outline-light">
