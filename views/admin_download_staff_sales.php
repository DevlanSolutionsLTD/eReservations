 ...
 */
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i> <b> Sales Recorded By ' . $user->user_name . ' | Generated On ' . date('d M Y') . '</b></i>
            </div>
            ...
            <h3 class="list_header" align="center">
                ...
                <hr class="red">
                <h4>' . $user->user_name . ' Sales Records </h4>
            </h3>
        ...
        while ($sales = $res->fetch_object()) {
            ...
            $html .=
                ...
                <tr>
                    ...
                    <td width="90%">
                    ' . date('d M Y g:ia', strtotime($sales->sale_date)) . '
                    </td>
                    <td width="90%">
                        Ksh ' . $total_price . '
                    </td>
        ...
        $html .= '
                <tr>
                    <td colspan="7">Total Sales For ' . $user->user_name . '</td>
        ...
        $dompdf->render();
        $dompdf->stream($user->user_name . ' Sales Records', array("Attachment" => 1));
