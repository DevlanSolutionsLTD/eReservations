                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>Welcome to Bookstore Inventory System.</p>
                                            </div>
                                                        ...
                                                        <div class="col-sm-4 col-lg-4 col-xxl-6">
                                                            <div class="card card-bordered">
                                                                <div class="card-inner">
                                                                    <div class="card-title-group align-start mb-2">
                                                                        <div class="card-title">
                                                                            <h6 class="title">Sales Posted</h6>
                                                                        </div>
                                                                    </div>
                                                                    <div class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                                                        <div class="nk-sale-data">
                                                ...
                                                <div class="card-inner border-bottom">
                                                    <div class="card-title-group">
                                                        ...
                                                        <div class="card-tools">
                                                            <a href="admin_sales" class="link">View All</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card card-bordered card-full">
                                                <div class="card-inner border-bottom">
                                                    <div class="card-title-group">
                                                        ...
                                                        <div class="card-tools">
                                                            <a href="admin_inventory_out_ofstock" class="link">View All</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <ul class="nk-activity">
