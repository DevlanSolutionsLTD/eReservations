        ...
        <div class="nk-split nk-split-page nk-split-md">
            <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container">
                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    ...
                    <?php $new_password = $_GET['pwd']; ?>
                    <form method="POST">
                        <div class="form-group">
                            <div class="form-label-group">
                                <label class="form-label" for="default-01">Copy</label>
                                <a class="link link-primary link-sm" tabindex="-1" href="index">Login and Update Password
                                </a>
                            </div>
                            <input id="defaul1" type="text" value="<?php echo $new_password ?>" class="form-control form-control-sm">
                            <button class="btn" data-clipboard-action="copy" data-clipboard-target="#defaul1"><i class="far fa-copy">Copy</i></button>
                        </div><!-- .foem-group -->
                    </form><!-- form -->
                </div><!-- .nk-block -->
