...
$html = '
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i> <b> Out Of Stock Products.  Generated On ' . date('d M Y') . '</b></i>
            </div>
            ...
            $html .=
                ...
                <tr>
                    ...
                    <td width="40%">' . $products->product_access_level . ' </td>
                </tr>
                            ';
                $cnt = $cnt + 1;
            }
...
$dompdf->render();
$dompdf->stream('Out Of Stock ', array("Attachment" => 1));
