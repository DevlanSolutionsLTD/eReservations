...
checklogin();
require_once('../partials/store_analytics.php');
...
<body class="nk-body npc-invest bg-lighter ">
    <div class="nk-app-root">
        ...
        <div class="nk-wrap ">
            ...
            $user_store = $_SESSION['user_access_level'];
            $ret = "SELECT * FROM  users WHERE user_id = '$user_id' AND user_access_level = '$user_store'";
            $stmt = $mysqli->prepare($ret);
            $stmt->execute(); //ok
            $res = $stmt->get_result();
            while ($user = $res->fetch_object()) {
                if ($user_store == 'store_1') {
                    $my_store = "Store 1";
                } else {
                    $my_store = "Store 2";
                }
                                    ...
                                    <div class="nk-block-between-md g-3">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                                <div>
                                                    <h2 class="nk-block-title fw-normal"><?php echo $user->user_name; ?> To <?php echo $my_store; ?></h2>
                                                </div>
                                                                            ...
                                                                            <div class="card-inner">
                                                                                <div class="card-title-group align-start mb-2">
                                                                                    <div class="card-title">
                                                                                        <h6 class="title">Store Products</h6>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="col-sm-6 col-lg-6 col-xxl-6">
                                                                        <div class="card card-bordered">
                                                                            <div class="card-inner">
                                                                                <div class="card-title-group align-start mb-2">
                                                                                    <div class="card-title">
                                                                                        <h6 class="title">Store Sales Posted</h6>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                                                                    <div class="nk-sale-data">
                                                    ...
                                                    <div class="col-md-6 col-xxl-6">
                                                        <div class="card card-bordered card-full">
                                                            <div class="card-inner border-bottom">
                                                                <div class="card-title-group">
                                                                    ...
                                                                    <div class="card-tools">
                                                                        <a href="store_sales" class="link">View All</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <ul class="nk-activity">
                                                                ...
                                                                INNER JOIN users u ON u.user_id = s.sale_user_id WHERE p.product_access_level = '$store'
                                                                    ...
                                                                    <li class="nk-activity-item">
                                                                        ...
                                                                        <div class="nk-activity-data">
                                                                            <div class="label">
                                                                                ...
                                                                                of <span class="text-dark"><?php echo $sales->product_name; ?> - <?php echo $sales->category_name; ?> </span> to <span class="text-dark"><?php echo $sales->sale_customer_name; ?> R.C.C , <?php echo $sales->sale_customer_phoneno; ?> D.C.C</span>.
                                                                                Payment of <span class="text-dark">Ksh <?php echo $total_price; ?></span> has been posted and Receipt Number :<b><?php echo $sales->sale_receipt_number; ?></b>, has been issued.
                                                                            </div>
                                                        ...
                                                        <div class="card card-bordered card-full">
                                                            <div class="card-inner border-bottom">
                                                                <div class="card-title-group">
                                                                    ...
                                                                    <div class="card-tools">
                                                                        <a href="store_reports_out_of_stock" class="link">View All</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <ul class="nk-activity">
                                                                ...
                                                                WHERE p.product_quantity <=1 AND  p.product_access_level = '$store'
                                                                ...
                                                                ?>
                                                                    <li class="nk-activity-item">
                                                                        ...
                                                                        <div class="nk-activity-data">
                                                                            <div class="label">
                                                                                <?php echo $products->product_name; ?> - <?php echo $products->category_name; ?><br>
