                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" required name="new_password" class="form-control form-control-lg" id="default-01">
                        </div><!-- .foem-group -->
                        <div class="form-group">
                            <div class="form-label-group">
                                <label class="form-label" for="default-01">Confirm New Password</label>
                            </div>
                            <input type="text" required name="confirm_password" class="form-control form-control-lg" id="default-01">
                        </div><!-- .foem-group -->
                        <div class="form-group">
                            <button type="submit" name="Confirm_Password" class="btn btn-lg btn-primary btn-block">Confirm New Password</button>
                        </div>
                    </form><!-- form -->
                </div><!-- .nk-block -->
