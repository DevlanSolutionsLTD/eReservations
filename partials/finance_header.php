                ...
                <div class="nk-header-menu" data-content="headerNav">
                    ...
                    <ul class="nk-menu nk-menu-main">
                        <li class="nk-menu-item">
                            <a href="accounts_home" class="nk-menu-link">
                                <span class="nk-menu-text">Home</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="accounts_out_of_stock" class="nk-menu-link">
                                <span class="nk-menu-text">Out Of Stock Products</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="accounts_store_1_sales" class="nk-menu-link">
                                <span class="nk-menu-text">Store 1 Sales</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="accounts_store_2_sales" class="nk-menu-link">
                                <span class="nk-menu-text">Store 2 Sales</span>
                            </a>
                        </li>
                    </ul>
                </div><!-- .nk-header-menu -->
