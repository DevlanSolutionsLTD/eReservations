...
$ret = "SELECT * FROM  users WHERE user_id = '$user_id' AND user_access_level = '$store'";
        ...
        <div class="container-xl wide-lg">
            <div class="nk-header-wrap">
                ...
                <div class="nk-header-brand">
                    <a href="store_home" class="logo-link">
                ...
                <div class="nk-header-menu" data-content="headerNav">
                    ...
                    <ul class="nk-menu nk-menu-main">
                        <li class="nk-menu-item">
                            <a href="store_home" class="nk-menu-link">
                                <span class="nk-menu-text">Home</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="store_products" class="nk-menu-link">
                                <span class="nk-menu-text">Products</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="store_sales" class="nk-menu-link">
                                <span class="nk-menu-text">Sales</span>
                            </a>
                        </li>
                        <li class="nk-menu-item">
                            <a href="store_stock_manager" class="nk-menu-link">
                        ...
                        <li class="nk-menu-item active has-sub">
                            ...
                            <ul class="nk-menu-sub">
                                <li class="nk-menu-item">
                                    <a href="store_reports_current_stock" class="nk-menu-link">
                                        <span class="nk-menu-text">Current Stock</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="store_reports_out_of_stock" class="nk-menu-link">
                                ...
                                <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                    <div class="user-card">
                                        ...
                                        <div class="user-action">
                                            <a class="btn btn-icon mr-n2" href="store_profile"><em class="icon ni ni-setting"></em></a>
                                        </div>
                                    </div>
                                </div>
