            ...
            <tr>
                <td>
                    <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            ...
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                Hi there, <br>
                                                You recently requested to reset the password for your <b> Ukamba Bible College Portal </b> account.
                                            </p>
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                        ...
                        <tr>
                            <td style="text-align:center;">
                                <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; ' . date('Y') . ' <strong> Ukamba Bible College. A <a href="https://devlan.martdev.info/"> DevLan Inc </a> Production</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td style="height:80px;">&nbsp;</td>
